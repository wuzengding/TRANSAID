...
Encoding: Adjust parameters in Encoding_structure2.py or modify input arguments in Encoding_run.sh
Training: Change hyperparameters (epochs, batch size, etc.) in Training_run.sh
Prediction: Modify model path or output settings in prediction_for_batch_run.sh
Analysis: Add custom metrics in Analyze_prediction3.py
Troubleshooting
