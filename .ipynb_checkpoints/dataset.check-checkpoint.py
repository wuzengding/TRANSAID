...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', type=str, required=True, help='Directory containing the encoded data files')
    ...
    parser.add_argument('--embedding_size', type=int, required=True, help='Size of the embedding layer')
