...
output_dir = 'encoded_data_start2_end1_long'
log_file = '/home/jovyan/work/insilico_translation/script/pre-processe_start_end.log'
...
def create_labels(seq, cds_regions, max_len):
    ...
    #labels[start+3: end-3] = 0 # Label coding region
...
plt.savefig('Distribution_of_mRNA_Sequence_Lengths.pdf')
